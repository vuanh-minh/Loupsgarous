...
export interface GameState {
  ...
  /** Wolf pre-selections made during the "Découverte des rôles" phase.
   *  Maps wolfId → pre-selected targetId. Checked at Night 1: if the target
   *  is present the confirmation overlay is shown pre-filled; if away the wolf
   *  must pick again normally. */
  discoveryWolfTargets?: Record<number, number>;
