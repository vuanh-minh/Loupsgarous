...
export function GamePanel({
  ...
  return (
    <div className="px-4 pb-6 flex flex-col min-h-full relative overflow-hidden" style={{ paddingTop: '1rem', paddingBottom: 'calc(93px + env(safe-area-inset-bottom, 0px))' }}>
      {/* Content */}
